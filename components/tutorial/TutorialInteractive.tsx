        ...
        <div className="relative flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-400">
              Sem palestra infinita: você avança em blocos curtos, marca o que já fez (fica salvo no
              navegador) e ainda pode pular direto pras telas do app.{" "}
          ...
          <div className="mt-6 grid gap-4 border-t border-slate-800/80 pt-6 md:grid-cols-2">
            <div>
              <div className="mb-3 flex items-center justify-between gap-2">
                ...
                <span className="rounded-full bg-slate-900/80 px-2 py-0.5 text-[10px] font-medium text-slate-500">
              ...
              {!isLast ? (
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button
                    ...
                    className="rounded-xl border border-slate-600 px-4 py-2.5 text-xs font-semibold text-slate-400 transition hover:border-slate-500 hover:text-slate-200"
                  >
                    Zerar checklists
                  </button>
                </div>
